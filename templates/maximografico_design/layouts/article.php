...
<article class="uk-article<?php if ($view === 'article') echo ' tm-blog-single'; ?> <?php if (isset($is_column_item) && $is_column_item) echo ' tm-article-column-item'; ?>" <?php if ($permalink) echo 'data-permalink="'.$permalink.'"'; ?>>
