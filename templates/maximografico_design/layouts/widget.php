...
else if (in_array($widget->position, array('toolbar-r' ,'toolbar-l', 'footer-left', 'footer-right', 'offcanvas'))) {
    $panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('toolbar-r' ,'toolbar-l', 'footer-left', 'footer-right', 'smoothscroll'))) {
    $title = '';
