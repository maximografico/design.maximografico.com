...
switch ($settings['link_style']) {
    ...
    case 'primary-large':
        ...
        break;
    case 'button-link':
        $button_link = 'uk-button uk-button-link';
        break;
    default:
        $button_link = '';
}
...
<div id="wk-grid<?php echo $settings['id']; ?>" class="tm-gallery-luna <?php echo $grid; ?> <?php echo $settings['class']; ?>" <?php echo $grid_js; ?> <?php echo $animation; ?>>
